...
_C.INPUT.HEIGHT_TRAIN = 928
# Maximum size of the side of the image during training
_C.INPUT.WIDTH_TRAIN = 1600
# Size of the smallest side of the image during testing
_C.INPUT.HEIGHT_TEST = 928
# Maximum size of the side of the image during testing
_C.INPUT.WIDTH_TEST = 1600
...
_C.DATALOADER.device_ids =[0,1,2,3]
_C.DATALOADER.BATCH_SIZE = 20
# ---------------------------------------------------------------------------- #
# Backbone options
# ---------------------------------------------------------------------------- #
...
_C.MODEL.BACKBONE.STACKS = 1
_C.MODEL.BACKBONE.BLOCKS = 2
...
# for weight unbalance of class
_C.MODEL.HEAD.CLASS_WEIGHT = [1, 1, 1, 1, 1, 1]
...
_C.MODEL.HEAD.DEPTH_RANGE = [0.1, 200]
...
_C.MODEL.HEAD.DIMENSION_MEAN = ((3.99331126, 1.54370861, 1.64175497),
                               (0.295, 1.6, 0.3175),
                               (1.34645161, 1.55322581, 0.3883871),
                               (2.503, 1.72 , 1.077),
                               (9.1775, 2.95, 2.3425),
                               (10.3655102,3.31632653,2.45469388),
                               (14.173476,3.223871,2.507529),
                               (4.824963,2.046904,1.78939))

_C.MODEL.HEAD.DIMENSION_STD =  ( (0.35223078,0.19156938,0.12989004),

...
# from model.backbone.hourglass_firstconv import HourglassNet
# from model.backbone.hourglass_firstconv import Bottleneck as btnk

from model.backbone.vggx2Small import vgg_backfpn_ensemble
...
def build_backbone(cfg):
    ...
    # if cfg.MODEL.BACKBONE.CONV_BODY == "hg_convtranspose":
    #     model = HourglassNet(btnk,num_stacks=cfg.MODEL.BACKBONE.STACKS, num_blocks=cfg.MODEL.BACKBONE.BLOCKS) 
    # if cfg.MODEL.BACKBONE.CONV_BODY == "hg_firstconv":
    #     model = HourglassNet(btnk,num_stacks=cfg.MODEL.BACKBONE.STACKS, num_blocks=cfg.MODEL.BACKBONE.BLOCKS) 
    # if cfg.MODEL.BACKBONE.CONV_BODY == "hg_maxpool":
    #     model = HourglassNet(btnk,num_stacks=cfg.MODEL.BACKBONE.STACKS, num_blocks=cfg.MODEL.BACKBONE.BLOCKS)
    if cfg.MODEL.BACKBONE.CONV_BODY == "Vggx2SmallNet":
        model = vgg_backfpn_ensemble()
    return model
